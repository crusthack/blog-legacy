...
# 개요
- 실제 서비를 구현해본 경험이 없어 Unity 프레임 워크 학습과 웹통신을 같이 학습하고자 함
- 간단한게 웹로그인 + 채팅 + 간단한 미니 게임 시스템만 구현한 뒤 점차 시스템 추가해나가면서 유지보수 할 수 있는 장기 프로젝트로 끌어가고 싶음
- 2026/03에 시작해 학기 중(6월까지)에 어느정도 완성하는게 목표
...
## 기술 스택
- Unity, C#, ASP.Net Core, Next.js, gRPC, SQLite,
