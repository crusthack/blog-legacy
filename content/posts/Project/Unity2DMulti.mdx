...
- 여러개의 Protobuf 메시지를 사용하기 위해 OpCode 값을 사용해 메시지 종류를 표시합니다. 
추가적인 Protobuf메시지를 등록하고자 하면, OpCode 추가 및 하단의 ProtobufParserRegistry에 메시지를 등록하면 됩니다.
...
블로그 포스트에 올린 코드는 그 이전 .Net 10.0으로 작성한 코드입니다. 